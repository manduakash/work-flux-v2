...
import {
    ...
    CalendarDays, Users, ChevronRight, Activity, Loader2
} from 'lucide-react';
...
const mockEmployeeReports = [
    { ID: "EMP-001", Name: "Sarah Jenkins", Dept: "Engineering", Present: 22, Absent: 0, Late: 2, Leave: 1, Total: 23, Punctuality: 95.6 },
    { ID: "EMP-002", Name: "Michael Chang", Dept: "Design", Present: 18, Absent: 2, Late: 5, Leave: 3, Total: 23, Punctuality: 78.2 },
    { ID: "EMP-003", Name: "David Kumar", Dept: "Sales", Present: 21, Absent: 1, Late: 1, Leave: 1, Total: 23, Punctuality: 91.3 },
    { ID: "EMP-004", Name: "Emily Ross", Dept: "HR", Present: 20, Absent: 0, Late: 0, Leave: 3, Total: 23, Punctuality: 100 },
    { ID: "EMP-005", Name: "James Wilson", Dept: "Engineering", Present: 15, Absent: 4, Late: 8, Leave: 4, Total: 23, Punctuality: 65.2 },
    { ID: "EMP-006", Name: "Anita Desai", Dept: "Marketing", Present: 22, Absent: 0, Late: 1, Leave: 1, Total: 23, Punctuality: 98.0 },
    { ID: "EMP-007", Name: "Robert Fox", Dept: "Sales", Present: 19, Absent: 2, Late: 3, Leave: 2, Total: 23, Punctuality: 82.6 },
    { ID: "EMP-008", Name: "Cody Fisher", Dept: "Design", Present: 21, Absent: 0, Late: 4, Leave: 2, Total: 23, Punctuality: 91.3 },
];
...
export default function UserwiseAttendanceExport() {
    ...
    // Filtering Logic
    const filteredData = mockEmployeeReports.filter(emp => 
    ...
    const handleExport = (type: 'csv' | 'pdf', empName: string = 'All_Users') => {
        // In reality, this triggers a file download via API
        alert(`Exporting ${type.toUpperCase()} report for ${empName}...`);
    };
    ...
    if (loading) {
        return (
            <div className="flex h-[80vh] w-full flex-col items-center justify-center gap-4">
                ...
                <p className="text-sm font-black uppercase tracking-[0.3em] text-slate-400">Generating Reports...</p>
            </div>
        );
    }
        ...
        >
            ...
            <motion.div variants={itemVariants} className="flex flex-col md:flex-row gap-4 bg-white dark:bg-slate-900 p-4 rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-sm items-center">
                ...
                <div className="flex gap-2 w-full md:w-auto">
                    <Button variant="outline" className="h-14 flex-1 md:flex-none rounded-3xl px-6 font-black uppercase tracking-widest text-[10px] border-slate-200 dark:border-slate-800">
                    ...
                    <div className="mb-6 p-10 pb-0 flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm font-bold text-slate-400 mt-1 uppercase tracking-widest">
                                Displaying {filteredData.length} records based on current filters
                            </p>
                        </div>
                    </div>
