...
export default function LeaveApplicationLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex h-screen overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
            ...
            <div className="flex flex-1 flex-col h-full overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto p-8 custom-scrollbar z-0 relative h-full font-sans">
                    <div
                        className="absolute inset-0 opacity-[0.6] dark:opacity-30 pointer-events-none bg-fixed"
                        style={{ backgroundImage: 'url("https://www.transparenttextures.com/patterns/padded-light.png")' }}
                    />
